...
public class CamelProcessorTest {
    ...
    public void process() throws Exception {
        ...
        final Consumer consumer = CamelContextAccess.CONTEXT.getEndpoint("direct:processor").createConsumer(new Processor() {
            @Override
    ...
    private static class CamelContextAccess extends CamelTask {
        // just to get access to CONTEXT
    }

...
import org.apache.batchee.gui.service.RestProperties;
import org.apache.batchee.gui.service.RestStepExecution;
...
public class RestTest {
    ...
    private WebClient newClient() {
        return WebClient.create(base.toExternalForm() + "api/", Arrays.asList(new JacksonJsonProvider())).accept(MediaType.APPLICATION_JSON_TYPE);
    }
}

...
public class BoundedThreadPoolServiceImpl extends AbstractThreadPoolServiceImpl {
    ...
    private static int getInt(final IBatchConfig batchConfig, final String key, final String defaultValue) {
        return Integer.parseInt(batchConfig.getConfigProperties().getProperty(key, defaultValue));
    }
}

...
public class JobControllerImpl extends JobThreadRootControllerImpl {
    private JobControllerImpl(final RuntimeJobExecution jobExecution, final long rootJobExecutionId) {
        super(jobExecution, rootJobExecutionId);
    }

    public JobControllerImpl(final RuntimeJobExecution jobExecution) {
